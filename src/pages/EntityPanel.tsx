  ...
  return (
    <div className="space-y-6 p-6">
      <SiteCorpPageHeader
        ...
        description={`${entityTypeLabels[currentEntity.entity_type] || "Entidad"} • ${currentEntity.code}`}
      />
        ...
        <SiteCorpCard title="Accesos rápidos">
          <div className="space-y-3">
            <p className="text-xs text-muted-foreground">
              Navega por los módulos operativos y de administración de esta entidad.
            </p>
            <div className="grid gap-2">
              ...
              <a
                ...
                className="flex items-center gap-2 rounded-lg border border-border p-3 text-sm text-ink hover:bg-muted transition-colors"
              >
                <ShieldCheck className="h-4 w-4 text-sitecorp-primary" />
                Contratación
              </a>
            </div>
          </div>
